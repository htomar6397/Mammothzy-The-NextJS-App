    ...
    <div className="flex flex-col gap-1 w-full ">
      <div className="space-y-1 w-full flex flex-col gap-[0.35rem] border-[1px] border-[#E5E5E5] shadow-sm rounded-full">
        ...
        >
            ...
            <div className="rounded-full w-5 h-5 overflow-hidden flex items-center justify-center bg-gray-200">
              <Image
                src={`https://flagcdn.com/w40/${
                  countries.find((c) => c.dialCode === value?.dialCode)?.flag ||
                  "in"
                }.png`}
                width={20}
                height={20}
          ...
          {/* Divider */}
          <div className="h-6 w-[1px] bg-[#E5E5E5] absolute left-[3.7rem]" />
          {!value && (
            <span className="absolute text-xs top-1/2 right-[38%] text-red-500 transform -translate-y-1/2 pointer-events-none">
              *
            </span>
          )}
          <input
            ...
            className={`  px-[0.56rem] h-[2.525rem] rounded-r-full text-[12px] leading-[20px] focus:outline-none placeholder:text-gray-500`}
          />
